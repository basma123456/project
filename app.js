 ...
 * @param {function} it needs two parameters : the first is internal function , 
 * @param {options} the second is options
 * first parameter :
         **internal function : 
         * @description its inside the constructor as a parameter to it and it needs two paramenters
         * @param {entries}
         * @param {observer}
